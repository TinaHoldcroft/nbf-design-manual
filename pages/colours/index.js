    ...
    return (
        <section id='farger'>
            ...
            <div>
                ...
                <div>
                    <input type="color" id="gul" name="gul" value="#FFDF00" />
                ...
                <div>
                    <input type="color" id="fersken" name="fersken" value="#FFA76A" />
                    <label for="fersken">fersken</label>
                    <p>PMS: 714</p>
                    <p>CMYK: 0/45/64/0</p>
                    <p>RGB: 255/167/106</p>
                    <p>#FFA76A</p>
                ...
                <div>
                    <input type="color" id="sort" name="sort" value="#000000" />
                ...
                <div>
                    <input type="color" id="hvit" name="hvit" value="#FFFFFF" />
                    <label for="hvit">hvit</label>
                    <p>PMS: 714</p>
                    <p>CMYK: 0/0/0/0</p>
                    <p>RGB: 55/255/255</p>
                    <p>#FFFFFF</p>
